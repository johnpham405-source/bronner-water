...
**Skip:** Starkey (9.5–10 ppb arsenic across three years of CR tests, after a recall), Peñafiel (18 ppb after claiming non-detect; withdrawn 2019), Crystal Geyser Alpine (parent's DOJ double-felony over arsenic filtration waste). **Caution:** Topo Chico (highest PFAS CR measured, 9.8 → ~3.9 ppt). Poland Spring: labeling litigation only, no contamination finding. Saratoga, Liquid Death, Essentia, the rest: no verifiable data.

**Microplastics — assume them in every bottle.** 93% of 259 bottles tested positive (avg 325 particles/L, 31× brand spread); counting nanoplastics multiplies by ~1,000 (~240,000/L, contested). Glass is not a guaranteed escape — one study found glass 7× cleaner, another found it worse; caps and bottling machinery are implicated in both. So plastics promises carry no weight in the ranking; chemistry documentation does.
...
**Hurricane stockpile:** stock PET cases indoors when convenient — **never in a vehicle** (interiors reach 60–70 °C, the measured danger range; a 35–45 °C garage sits below every measured harm threshold). Rotate 6–12 months as prudence — hot-storage data stops at eight weeks. Skip aluminum cans (far higher bisphenols than PET). Dominant real risks: volume (~28 gal for two adults × two weeks), seal breach, container failure.
...
**Correction logged:** our first registry sweep missed Evian's NSF listing (filed under its French corporate name); the cross-audit caught it, we re-verified against the live registry, and Evian was upgraded. Registry searches must try corporate-name variants.
