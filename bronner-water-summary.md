...
**The catch — capacity.** Certified at **50 gallons per element** (150 with three) at roughly **$1.05–$1.38 per certified gallon**, and gravity flow is slow (~8 hours per full chamber). Mind the gap between registry and sales copy: Culligan says "up to 6 months" and former ProOne dealers claimed **1,000–1,200 gallons**, against a certified rating of **50**. Past 50 gallons you are outside the certified envelope. That is adequate for the job we are buying it for (two adults for two weeks ≈ 28 gallons) but poor as a daily driver — which is why the under-sink RO remains the everyday system.
...
**Why this is effectively the only choice.** A full sweep of NSF's registry shows the "pour-through gravity" category contains exactly **one** certified product worldwide (Doulton's British Berkefeld SS2 — and only for cyst and turbidity), and just one pour-through unit anywhere carries a PFAS claim. The category is the constraint, not the budget.

**Traps in this category** (checked against the registries, not the marketing):
- **Berkey** — EPA stop-sale order FIFRA-08-2023-0038 on Black Berkey elements. Its NSF listing covers chlorine/taste-odour on a *Phoenix* element, not Black Berkey, and nothing for lead or PFAS.
- **Boroux** (Berkey successor, founded by its former largest US distributor) — advertises "WQA-Certified": true, but only NSF/ANSI 42, 401 and 372. Lead and PFAS are lab-tested, not certified.
