...
| Brand | Publishes the lab report | NSF listed | NY certified | Package plastics tested |
|---|:-:|:-:|:-:|:-:|
| **Evian** (glass) | ✓ | ✓ | ✓ | — |
...
Columns are ranked left to right; Evian is the only brand that clears the first, and adds both certifications. Evian's own gaps: one audited lot per year, no plastics test.
