...
| Brand | Clean, checkable lab report | NSF listed | NY certified | Package plastics tested |
|---|:-:|:-:|:-:|:-:|
| **Evian** (glass) | ✓ | ✓ | ✓ | — |
| Icelandic Glacial (glass) | — | ✓ | — | ✓ |
| Fiji (PET) | — | ✓ | ✓ | — |
| Mountain Valley (glass) | — | — | — | — |
| Nearly every other brand | — | — | — | — |

Columns are ranked left to right; Evian is the only brand that clears the first, and adds both certifications. Evian's gaps are real too: one audited lot per year, and no plastics test — nobody can say whether Evian's water carries more or fewer microplastics than Fiji's; glass simply removes PET's heat chemistry from the question.
