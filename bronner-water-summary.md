...
- **W-17177** NSF/ANSI 53 — **Lead + Total PFAS** (7 compounds: PFOA, PFOS, PFHxS, PFNA, PFHpA, PFBS, PFDA)
...
- Models MCVB/MCVP (Venture), MCSB/MCSP (Scout); element MCF701. **No NSF P231** — chemical filtration, not a microbial purifier.

**The catch — capacity.** Certified at **50 gallons per element** (150 with three) at roughly **$1.05–$1.38 per certified gallon**, and gravity flow is slow (~8 hours per full chamber). Culligan's marketing says "up to 6 months"; the registry says 50 gallons. That is adequate for the job we are buying it for (two adults for two weeks ≈ 28 gallons) but poor as a daily driver — which is why the under-sink RO remains the everyday system.
...
**Traps in this category:** Berkey remains under EPA stop-sale order FIFRA-08-2023-0038. **Boroux** (the Berkey successor, from its former largest distributor) advertises "WQA-Certified" — true, but it covers only particulates, microplastics and lead-*free materials*; its lead and PFAS claims are lab-tested, not certified (no NSF/ANSI 53 listing). Alexapure, Clearly Filtered gravity, and Doulton/British Berkefeld have no certified lead or PFAS claim either.
