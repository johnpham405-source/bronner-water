...
- Culligan MaxClear Venture gravity system (3 gal stainless — run 3 elements; replaces the discontinued ProOne Big+): https://shop.culligan.com/products/venture-maxclear-gravity-system — replacement filters: https://shop.culligan.com/products/maxclear-replacement-filter
...
- Treatment: 21 surficial wells lime-softened + 6 Floridan wells (4 via reverse osmosis), blended. Lime softening typically leaves water alkaline; finished pH is not published — a tap pH test confirms.
- Classic regulated contaminants are within limits at the system level. Premises lead/copper need home-specific testing.
...
**PFAS certification, plainly:** no certification under any standard yet proves reduction to the 4-ppt MCL (EPA says so itself); these are certification floors, not measured ceilings, and because RO removes PFAS by membrane physics, most competent RO systems would pass if submitted. Certification is verification plus a defined endpoint — and the G3P800 carries the strongest certified package available, which is why it wins on the evidence.

### How the certifications stack up

| System | Position | Registry certification | PFAS claim | Lead & copper | Bottom line |
|---|---|---|---|---|---|
| Waterdrop G3P800 | **The pick** | IAPMO: NSF/ANSI 42, 53, 58, 372 | CERTIFIED Total PFAS to a 20-ppt endpoint + PFOA/PFOS/PFNA/PFHxS — tightest certified claim in the field | Certified lead + copper (plus arsenic, nitrate, TDS) | Most-certified system reviewed, and tankless |
| Multipure Aqualuxe | Runner-up | NSF: 42, 53, 401, P231 | Certified PFOA/PFOS at the older 70-ppt endpoint | Certified lead; no copper claim | Exemplary carbon block — silent on copper, TDS, nitrate |
| Cloud RO | Premium alternative | NSF/ANSI 58 (whole system, incl. its remineralizer) | SGS lab-tested only — not a certified claim | SGS lab-tested only — not certified | Best ownership experience; tank-based |
| Pentair FreshPoint GRO | Alternative | IAPMO: NSF/ANSI 53 Total PFAS + 58 | Certified Total PFAS | Listing not re-checked here | Certified RO from a major brand; tank-based |
| Culligan Aquasential Smart RO | Dealer white-glove | WQA: NSF/ANSI 42, 53, 58, 372, 401 | Registry-certified PFAS | Certified (WQA listing) | Same coverage class at 3–5× cost, with a service contract |
| Kinetico K5 | Dealer white-glove | WQA: NSF/ANSI 58 | Certified PFOA/PFOS | Listing not re-checked here | Service-first dealer option |
| Waterdrop X12/X16 | Dropped | NSF/ANSI 42, 58, 372 — no 53 | NOT certified | NOT certified | More flow and looks; health claims uncertified |
| Aquasana SmartFlow | Dropped | Certified, older scope | Older 70-ppt PFOA/PFOS endpoint | Certified lead | Plastic tank, 3.8-star owners — superseded by the pick |

"Certified" = the exact model's claim sighted in the certifier's own registry (NSF, WQA, IAPMO). A lab report ("tested to", SGS) is evidence, not certification.

### What each certification covers, and why it matters here

| Standard | What it certifies | Why it matters for this water |
|---|---|---|
| NSF/ANSI 42 | Aesthetics: chlorine taste/odor, particulates | Baseline comfort only — says nothing about health contaminants |
| NSF/ANSI 53 | Health contaminants: lead, PFAS, VOCs, cysts | The load-bearing standard here — the PFOS exceedance and lead both live under 53 |
| NSF/ANSI 58 | RO systems: TDS reduction + whole-system material safety | The RO-specific standard; contaminant claims can also be certified under it |
| NSF/ANSI 372 | Lead-free wetted materials | The hardware itself cannot leach lead |
| NSF/ANSI 401 | Emerging contaminants: pharmaceuticals, some pesticides | Breadth beyond the regulated list — useful, not decisive |
| NSF/ANSI 60 | Chemicals/media added to water (e.g. remineralization minerals) | None of the remineralizers compared holds it, so their mineral claims are unverified |
| NSF/ANSI 177 | Shower filters — free chlorine only | No shower filter anywhere is certified for chloramine — why the outdoor-shower answer is treating the line |
| NSF P231 | Microbiological purifiers (bacteria, viruses) | Relevant to the emergency gravity filter, not the city-water RO decision |

## 4. Testing won't change the decision — it tunes the add-ons

**Testing will NOT change:** the need for point-of-use drinking treatment (PFOS is already measured on this supply); the recommendation against whole-house RO; the value of a smart shutoff for a vacant home; the emergency gravity filter; the whole-house carbon rationale.
...
**Whole-house hardware front-runners** (final model + tank size chosen with the install quote after baseline results):
- **Kinetico Chloraban CRS** — certification leader: the only residential system with a WQA-certified whole-house *chloramine* claim (NSF/ANSI 42); dealer-sized and installed: https://www.kinetico.com/specialty-solutions/chloramine-reduction-system-crs/
- **Pentair PC1000** (catalytic carbon) — self-serviceable alternative: IAPMO-certified NSF/ANSI 42 + 61, but the certified claim is chlorine taste/odor, not chloramine: https://www.pentair.com/en-us/water-softening-filtration/whole-house/products/whole-house-water-filters.PC1000-P.html
- Aquasana Rhino and SpringWell CF were reviewed and set aside (tested-to claims only, no certified system listing).
...
| Culligan MaxClear Venture gravity system (3 elements) + stored-water baseline | **Buy now** (plan on 50 certified gal per element; stock spares) |
...
## 6. Blue-green tub staining: what it means

Almost certainly **copper** — dissolved from the home's own plumbing/brass fixtures while water sits, deposited as it evaporates. Not a tub-filter problem (the copper enters the water upstream of the tub). Not the city's fault (their LCR sampling passes; lime-softened water is typically alkaline). Almost never a repipe.

Likeliest driver: **months-long seasonal stagnation**, possibly amplified by chloramine decay → nitrification in premise plumbing during vacancy (lowers pH inside the pipes), plus brass fixture dezincification at a dripping spout.

**Decision rules after testing:**
- First-draw copper high, flushed normal → stagnation/fixture issue: arrival flush routine, maybe a DZR brass spout. No whole-house treatment.
- Both high → systemic: check pH/alkalinity/LSI; if pH low → calcite neutralizer (installed FIRST in the train); if pH fine → plumber (pipe coupon) + grounding check.
- Copper normal but stains persist → brass trim, cleaning products, or mildew — not dissolved copper.
- pH and copper both normal → do NOT buy pH neutralization.
- Repipe only for recurring pinholes or confirmed wall thinning. Staining alone never justifies it.
...
- **"BPA-free" on PP/PE is a truism** — BPA was never in those plastics. Marketing noise.
- Conventional RO tank wetted materials: **polypropylene liner + butyl rubber diaphragm** (the steel shell never touches water). Hours of dwell — the largest plastic-contact term in any under-sink system. Stainless-SHELL tanks usually keep the same internals (cosmetic).
- **RO membranes remove essentially all incoming microplastics** (~99.9%+); tap water arrives with roughly 5–60 particles/L — the system removes far more than its cold plastic parts plausibly add back (net win, though no end-to-end study exists).
- No certification standard tests device shedding (NSF 58/61 test chemical extraction; NSF 401 microplastics = removal of incoming particles). No product can prove it doesn't shed.
- WHO (2019, reaffirmed 2022): drinking-water microplastics are a low health risk on current evidence.
- Low-plastic ranking: (1) stainless-housing carbon block (Aqualuxe), (2) tankless RO, (3) tanked RO (the pick — mitigations: metal faucet, short runs, daily turnover, seasonal drain), (4) don't buy stainless-shell tanks or "BPA-free" labels as safety credentials.

## 10. Gravity filter: Culligan MaxClear (replaces the discontinued ProOne)

**ProOne is gone.** Culligan acquired the brand and wound it down — the Big+ and Traveler+ are sold out and discontinued (final sale, no returns), and only the 7-inch element survives. **The pick is now the Culligan MaxClear Venture** (3 gal stainless, ~$199) running **three elements**.

**Certification (registry-verified at IAPMO, July 2026) — broader than ProOne's was:**
- **W-17177** NSF/ANSI 53 — **Lead + Total PFAS**. "Total PFAS" is an *aggregate* claim covering the seven regulated compounds tested as a mixture (PFOS among them) to a 20-ppt endpoint, reported as one combined figure (99.6%) rather than a named PFOS percentage. PFOS is covered; it is just not broken out. (The under-sink G3P800 *does* name PFOA/PFOS/PFNA/PFHxS individually.)
- **W-17176** NSF/ANSI 42 — chlorine, **chloramine**, particulate Class I *(chloramine matters here — it is what Vero Beach uses)*
- **W-17178** NSF/ANSI 401 — microplastics + 7 pharmaceutical/pesticide surrogates
- **W-17179** NSF/ANSI 372 — lead-free materials
- Models MCVB/MCVP (Venture), MCSB/MCSP (Scout); element MCF701. Certificates effective Jan 2025, valid to Jan 2030. **No NSF P231** — chemical filtration, not a microbial purifier.
- Housing is stainless, but **Culligan does not publish the grade** (ProOne documented 304).
- **To verify it yourself:** IAPMO's registry only returns these listings when you search by **Listee Name = MaxClear** — free-text searches for "MaxClear" or "Culligan" return nothing, which can wrongly look like a fake certification. Look for file **W-17177**.

**The catch — capacity.** Certified at **50 gallons per element** (150 with three) at roughly **$1.05–$1.38 per certified gallon**, and gravity flow is slow (~8 hours per full chamber). The registry and the sales copy disagree sharply: Culligan says "up to 6 months" and former ProOne dealers claimed **1,000–1,200 gallons**, against a certified rating of **50**. Past 50 gallons you are outside the certified envelope. That is adequate for the job we are buying it for (two adults for two weeks ≈ 28 gallons) but poor as a daily driver — which is why the under-sink RO remains the everyday system.

**Certification correction to an earlier version of this report:** ProOne's Lead and Total PFAS claims *were* genuinely IAPMO-certified (file W-16837, listed 10/22/2024) — not merely lab-tested as previously stated here. The registry listing post-dated that earlier research.

**The category is the limit.** A full sweep of NSF's registry shows the "pour-through gravity" category contains exactly **one** certified product worldwide (Doulton's British Berkefeld SS2 — and only for cyst and turbidity), and just one pour-through unit anywhere carries a PFAS claim. No amount of budget buys a better-certified gravity filter today.

**Traps in this category** (checked against the registries, not the marketing):
- **Berkey** — the Black Berkey element **is not currently sold at all**. EPA stop-sale orders went to several Berkey distributors in 2022–23 (incl. FIFRA-08-2023-0038) over its virus-“purifier” claims, and the manufacturer replaced it with an India-made *Phoenix* element in Nov 2025. Berkey's NSF listing covers chlorine/taste-odor on that Phoenix element — nothing for lead or PFAS.
- **Boroux** (founded by Berkey's former largest US distributor) — advertises "WQA-Certified": true, but the listing covers only **particulate Class I, microplastics and lead-free materials**. Its lead and PFAS figures are R&D lab tests (the lead one to a *modified* protocol). The tell: Boroux's own disclaimer drops the entire lead/PFAS list **in California and Iowa** — the two states that police device performance claims.
- **British Berkefeld / Doulton** — retail copy advertises certified PFAS and lead on the gravity systems; NSF's own registry shows **cyst and turbidity only**. Lead is certified only on their plumbed-in inline housings.
- **Alexapure Pro** — no certification in any registry, and its own retailer states it "has not been tested specifically for perfluorinated chemicals."
- **LifeStraw** — certifies lead on a single glass-pitcher SKU (WQA) and PFAS on nothing; their own help centre confirms it is not marketed as PFAS-certified.
- **Clearly Filtered** — makes no gravity product; holds only NSF/ANSI 42 + 372. (Best published *evidence* in the category, though: 35 PFAS compounds from an ISO 17025 lab.)

**Capacity alternative:** **4Patriots Patriot Pure Ultimate** (~$249) is dual-certified by NSF International *and* IAPMO (W-16354) at **200 gallons** per element (~$0.50/certified gallon — a third the cost). Trade-off: PFAS scope is **PFOA + PFOS only**, no microplastics claim, and 4Patriots is a direct-response preparedness marketer with a weaker brand-stability record. https://4patriots.com/product/patriot-pure-ultimate-water-filtration-system-nanomesh-filter

**One unresolved flag:** a single independent bench review of MaxClear reported dichloromethane in filtered water and a sulfate increase, attributed to manufacturing. Single source, one unit, not replicated — not treated as established, but worth knowing.

## 11. Smart shutoff (plain terms)
...
**The pick: Evian in glass.** Every brand says its water is clean; Evian is the only one whose claim you can check — the certifier's own lab report on a named 2025 production lot shows **arsenic ND at a 1 ppb reporting limit and an 18-compound EPA 537.1 PFAS panel ND at 2 ppt** (NSF; we read the report). Publishing alone proves nothing — what wins is clean results at the strictest limits any brand demonstrates, in a document anyone can verify. No other brand ties a finished-product lot to a checkable report. Primary documents: Evian's NSF report (https://s3.us-east-1.amazonaws.com/DigitalVideos/noram/waters/evian/Evian-AWQR-English-2025.pdf), the Eurofins glass-package plastics report (https://cdn.shopify.com/s/files/1/0289/0132/files/Glass_R2600877-2_Microplastics_Analysis_Water_Eurofins_2026-04-29.pdf?v=1777491171), the live NSF listings for Evian and Fiji (info.nsf.org), and Icelandic Glacial's NSF source-water report (https://cdn.shopify.com/s/files/1/0289/0132/files/COA_USFDA_50_STATE_Source_2026.pdf?v=1775853980).

**What to buy, by situation:** travel/guests = Evian glass · PET cases (coolers, cases on hand) = Fiji · plastics-documentation-first = Icelandic Glacial glass · backup glass = Acqua Panna (certification only, no published report) · every day = the RO faucet. Order of preference: Evian in glass wherever glass works — the other picks are for jobs glass handles badly (cases, coolers, weight), not because they beat it.

**Four tests separate evidence from marketing, in rank order.** Most brands fail all four — that is the central finding.
1. **Clean results in a report you can check** (the certifier's own document: named lot, lab, methods, detection limits — publishing alone proves nothing; clean results at strict limits in a verifiable document do) — *Evian only*
2. **A certifier audits them every year** (NSF public listing + NY annual recertification) — *Evian, Fiji, Icelandic Glacial*
3. **The package itself is lab-tested for plastics** — *Icelandic Glacial only* (Eurofins Py-GC/MS, all 10 polymers below quantification; brand-submitted samples, 0.7 µm floor)
4. **The trap: a summary sheet** — a brand's own "typical values" table proves nothing. Peñafiel's said non-detect while its water measured 18 ppb arsenic.
5. **The tiebreaker: package format** — glass avoids PET's heat chemistry outright; a narrow edge that says nothing about the water inside.

| Brand | Strongest public evidence | Key limitation | Role | Confidence |
|---|---|---|---|---|
| **Evian** (glass) | Certifier's own lab report on a named 2025 lot: arsenic ND at 1 ppb, 18 PFAS ND at 2 ppt | One audited lot/year; no plastics test | First choice wherever glass works | High |
| Icelandic Glacial (glass) | Eurofins package plastics reports + original 2026 NSF source-water report (arsenic ND at 1 ppb) | Source spring, not a finished bottled lot; no PFAS panel | Plastics-documentation priority | Moderate |
| Fiji (PET plastic) | NSF listing + NY annual certification | Arsenic figure is a brand sheet; 2024 Class III recall | Fallback where glass is impractical | Moderate |
| Acqua Panna (glass) | NY annual certification + annual water-analysis summary (2025: arsenic ND; PFAS listed ND) | Summary names no lab, lot, methods, or reporting limits; no NSF listing | Backup glass option | Moderate-low |
| Mountain Valley (glass) | Its own summary sheet | No original report; no NSF or NY listing | Wait for documentation | Low |

Confidence grades the public evidence, not the water — a low grade means unverified, not unsafe. Evian leads because its evidence sits at the top of the ladder (the certifier's own clean report), not because it collects the most items. Whether its water carries more or fewer microplastics than Fiji's is unmeasured; glass simply removes PET's heat chemistry from the question.

**History worth knowing (old records, not current rankings):** skip Starkey (9.5–10 ppb arsenic across three years of CR tests, after a recall), Peñafiel (18 ppb after claiming non-detect; withdrawn 2019), Crystal Geyser Alpine (parent's DOJ double-felony over arsenic filtration waste — a governance red flag, not a finished-water finding). **Caution:** Topo Chico (highest PFAS CR measured, 2020: 9.8 → ~3.9 ppt; total-PFAS product tests are a different metric than the tap's single-compound PFOS, but the same order of magnitude). Poland Spring: labeling litigation only, no contamination finding. Saratoga, Liquid Death, Essentia, the rest: no verifiable data.

**Microplastics — assume them in every bottle.** 93% of 259 bottles tested positive (avg 325 particles/L, 31× brand spread — 2017-era lots: San Pellegrino 30/L … Pure Life 930/L; variability, not a current ranking); counting nanoplastics multiplies by ~1,000 (~240,000/L, contested). Glass is not a guaranteed escape — one study found glass 7× cleaner, another found it worse; caps and bottling machinery are implicated in both. So plastics promises carry no weight in the ranking; chemistry documentation does.

**Regulatory gaps (why the label can't be trusted):** FDA's arsenic limit matches EPA's (10 ppb) but FDA can't require certified labs or violation reporting (GAO); no consumer report-card requirement; the federal testing floor is finished product once a year (21 CFR 129.80); **no FDA PFAS limit** - rulemaking underway but unsettled in timing and scope (EPA's May 2026 proposal would push tap PFOA/PFOS compliance to 2031 and reconsider four other limits, and FDA's rule is tied to EPA's); over-limit water may legally be sold labeled "Contains Excessive [contaminant]." "Certified Microplastic-Free" seals certify package materials, not tested water. NSF registry gotcha: brands list under corporate names (Evian under Société Anonyme des Eaux Minérales d'Evian).

**Storing it (two rules for a Florida house):** keep cases **indoors** — a 2020 study measured antimony above the 6 ppb federal limit within 24 hours at 122 °F / 50 °C (8.5 ppb; 16.8 by day 7 — Allafi 2020, read in full), while 77 °F stayed clean for three months; a 95–113 °F garage sits below the measured line but the margin is thin. **Never leave water in a vehicle** (interiors reach 140–158 °F). Rotate 6–12 months as prudence (measurement stops at ~8 weeks). Skip aluminum cans — bisphenols measure significantly higher in canned drinks than same-brand plastic/glass (Marchiandi 2024).
...
**Corrections logged:** (c) a third audit pass upgraded Acqua Panna (publishes an annual water-analysis summary; 2025 edition sighted) and Icelandic Glacial (original 2026 NSF source-water report, read in full), and softened the FDA PFAS date to "unsettled" - no ranking changed; also (a) hurricane heat guidance tightened — a 2020 study measured antimony above the federal limit within 24 hours at 50 °C, so the earlier '65 °C for two weeks' floor was wrong and garage storage is now 'overflow only'; (b) our first registry sweep missed Evian's NSF listing (filed under its French corporate name); the cross-audit caught it, we re-verified against the live registry, and Evian was upgraded. Registry searches must try corporate-name variants.
...
---
*Prepared by John, July 2026. Full interactive report with evidence links, comparison tables, and the presentation deck: bronner-water-report.vercel.app (advisory-v2 revision).*
