...
## 10. ProOne positioning

Strong emergency gravity filter (hurricanes, outages) and a good supplemental unit for homes without under-sink filtration — including the rental house (big tea/cooking batches). Less convenient than under-sink for a primary kitchen (fill-and-wait). More defensible than Berkey (EPA stop-sale on Berkey elements; ProOne holds an actual NSF/ANSI 42 certification plus independent PFAS/lead test reports — reports, not certified listings, hence "conditional"). Buy spare elements up front: the brand is being wound down under its acquirer.
